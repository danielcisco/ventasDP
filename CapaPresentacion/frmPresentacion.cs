...
{
    public partial class frmPresentacion : MaterialForm
    {
        ...
        public frmPresentacion()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtDescripcion, "Ingrese una descripción de la presentación");
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.txtNombre.Text == "Nombre")
                {
                    ...
                    errorIcono.SetError(txtDescripcion,"Sugiera una descripcion de la presentacion");
                }
                else
                {
                    if (this.IsNuevo)
        ...
        {
            if (txtBuscar.Text == "Presentacion a Buscar")
            {
                txtBuscar.Text = "";
        ...
        private void txtBuscar_Leave(object sender, EventArgs e)
        {
            if (txtBuscar.Text == "")
            {
                txtBuscar.Text = "Presentacion a Buscar";
        ...
        {
            if (txtNombre.Text == "Presentacion")
            {
                txtNombre.Text = "";
